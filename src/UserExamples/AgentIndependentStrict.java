...
public class AgentIndependentStrict extends BaseAgent {
...
//    static String searchLog;
    ...
    public AgentIndependentStrict(long id, CityMap map) {
        super(id, map);
        timer = 0;
        prev_cluster = -1;
        prev_time = -1;
...
//                }
        ...
        Integer target = epsTool.choiceByProbability(options);
...
//        }
        ...
        if (c.id == planned_destination_cluster){
            canpickup = true;
        }
        int cluster_id = c.id;
